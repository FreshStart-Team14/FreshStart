...
// SharedPreferences is flutter plugin to store data in key-value format on user device
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          TableCalendar( //Calendar, third party package for calendar, focusedDay is a property of this package
            focusedDay: _selectedDay,
            firstDay: DateTime.utc(2020, 1, 1),
            lastDay: DateTime.utc(2030, 12, 31),
            calendarFormat: _calendarFormat,
          ...
          ElevatedButton(
            onPressed: _saveNonSmokingDay,
            child: Text('Add Non-Smoked Day'), //After tapping to the button connected method will be launched
          ),
          ElevatedButton(
            onPressed: _resetData,
            child: Text('Reset Streak, XP, and Level'), //After tapping to the button connected method will be launched
          ),
          SizedBox(height: 20),
          Text('Current Streak: $_currentStreak days'),
          Text('Total XP: $_totalXP'),
